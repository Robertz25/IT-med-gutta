...
const nr1AsciiTest = "\x22\x23\x10\x81\x82"
const nr2AsciiTest = "\x43\x82\x85\x87\x88"   //testnummere
const passerTest = "\x80\xf7\xbe"       // <- Kan benyttes i iso_test.go for pass.
